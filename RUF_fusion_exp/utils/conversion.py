...
def paired_random_crop(img_gts, img_lqs, img_refs, gt_patch_size, gt_path, scale=2):
    """Paired random crop.
    ...
    # # crop ref patch
    # img_refs = [
    #     v[top_ref:top_ref + ref_patch_size, left_ref:left_ref + ref_patch_size, ...]
    #     for v in img_refs
    # ]
    ...
    # crop corresponding ref patch
    top_ref, left_ref = int(top_lq * scale), int(left_lq * scale)
    img_refs = [
        v[top_ref:top_ref + gt_patch_size, left_ref:left_ref + gt_patch_size, ...]
        for v in img_refs
    ]
